      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-4xl mx-auto leading-relaxed">
            Specializing in process instrumentation, vacuum technology, high-temperature furnaces, 
            and precision measuring instruments for pharmaceutical, medical, and R&D applications.
          </p>
        ...
        >
          ...
          <div className="glass-effect rounded-lg p-6 text-center animate-float" style={{ animationDelay: "0.5s" }}>
            <h3 className="text-3xl font-bold text-primary mb-2">500+</h3>
            <p className="text-muted-foreground">Projects Completed</p>
          </div>
          <div className="glass-effect rounded-lg p-6 text-center animate-float" style={{ animationDelay: "1s" }}>
